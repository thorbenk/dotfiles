...
wk.register({
  ["<leader>"] = {
    f = {
      name = "+file",
      b = { "<cmd>lua require 'telescope.builtin'.buffers(require('telescope.themes').get_ivy({ previewer = false, layout_config = { width = 0.75 } }))<cr>", "buffers", noremap=true, silent=true },
      ...
      f = { "<cmd>lua require 'telescope.builtin'.find_files(require('telescope.themes').get_ivy({ previewer = false, layout_config = { width = 0.75 } }))<cr>", "files", noremap=true, silent=true },
      g = { "<cmd>lua require 'telescope.builtin'.live_grep(require('telescope.themes').get_ivy({ previewer = false, layout_config = { width = 0.75 } }))<cr>", "live grep", noremap=true, silent=true },
      w = { "<cmd>lua require 'telescope.builtin'.grep_string(require('telescope.themes').get_ivy({ previewer = false, layout_config = { width = 0.75 } }))<cr>", "grep string", noremap=true, silent=true },
    ...
    m = { 
      "<cmd>Make<cr>", "Make", noremap=true, silent=true
    },
